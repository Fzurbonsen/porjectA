...
// #include "vargas/main.h"
// #include "vargas/align_main.h"
// #include "vargas/graphman.h"
// #include "vargas/threadpool.h"

using namespace std;

#ifndef PROJECTA_VARGAS_HPP
#define PROJECTA_VARGAS_HPP

// Struct to hold parameters for abPOA
struct projectA_vargas_parameters_t {

};

// Struct to hold the inputs and outputs for abPOA
struct projectA_vargas_io_t {
    // TODO
};
...
// PRE:     vargas
//      vargas:          Pointer to an existing gssw project.
// POST:    vargas
//      vargas:          Nullpointer and gssw has been destroyed.
